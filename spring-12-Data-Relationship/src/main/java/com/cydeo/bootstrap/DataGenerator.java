...
//------------------------------------
        ...
        paymentRepository.save(payment2); // bu kısım paymenta cascade kısmını ekleyince çalıştı
        //------------------------------------

        System.out.println(paymentRepository.findById(2L).get().getPaymentDetail().getCommissionAmount());
        // BU kısım nereden hangi bilgiyi aldığını analamk için örnek.konsolda 5000.00 çıktısını aldık.
        paymentRepository.delete(payment1);// bunu yapınca sadece paymen1 silinmedi.
            // aynı zamanda paymentDetail1 da silinmiş oldu. çünkü cascade.All yaptık ve parentteki her haraket child etkilendi.
